...
function brandLogoHTML(isFooter) {
  ...
  return `<img src="${window.__rootPath || ''}assets/logo.svg" alt="Shivraj Ventures" height="${size}" style="display:block;height:${isFooter ? '42px' : '58px'};width:auto;" loading="lazy">`;
}
